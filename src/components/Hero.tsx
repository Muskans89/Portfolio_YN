    ...
    <section className="relative min-h-screen bg-gradient-to-br from-dark-bg via-navy to-dark-blue flex items-center px-4 sm:px-6 md:px-20 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          className="absolute top-10 left-2 sm:top-20 sm:left-10 text-cyan/40 text-4xl sm:text-7xl font-bold select-none"
        >
          &lt;/&gt;
        </div>
        ...
        <div
          ...
          className="absolute bottom-32 right-10 sm:right-20 w-20 h-20 sm:w-28 sm:h-28 border-3 border-electric-blue/35 rounded-lg select-none"
          style={{ clipPath: "polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)" }}
        />

        <div
          ref={(el) => (floatingElementsRef.current[2] = el)}
          className="hidden sm:block absolute top-1/3 right-1/4 w-40 h-40 rounded-full border-3 border-cyan/30 select-none"
        />

        {/* Data/Analytics Symbols */}
        <div
          ref={(el) => (floatingElementsRef.current[3] = el)}
          className="absolute bottom-1/4 left-1/3 text-electric-blue/35 text-4xl sm:text-6xl select-none"
        >
          ◈
        </div>
        ...
        <div
          ...
          className="hidden sm:block absolute top-1/2 left-1/4 text-cyan/25 text-8xl select-none font-bold"
        >
          →
        </div>
        ...
        <div
          ...
          className="hidden sm:block absolute top-1/4 right-1/3 w-16 h-16 rounded-full border-2 border-pink-500/25"
        />

        <div
          ref={(el) => (bgElementsRef.current[1] = el)}
          className="absolute bottom-1/3 right-1/4 w-12 h-12 border-2 border-purple/30"
          style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
        />

        <div
          ref={(el) => (bgElementsRef.current[2] = el)}
          className="hidden md:block absolute top-2/3 left-1/3 w-20 h-20 rounded-full border-2 border-cyan/20"
        />

        {/* Chart/Graph & Analytics Elements */}
        <div
          ref={(el) => (bgElementsRef.current[3] = el)}
          className="hidden md:block absolute top-1/3 left-1/4 text-electric-blue/20 text-5xl select-none"
        >
          📊
        </div>
        ...
        <div
          ...
          className="absolute bottom-1/4 right-1/3 text-cyan/15 text-4xl sm:text-6xl select-none"
        >
          ⟡
        </div>
      ...
      <div
        ref={letterRef}
        className="absolute -right-20 sm:right-0 top-1/2 -translate-y-1/2 select-none pointer-events-none"
      >
        <svg className="w-64 h-64 sm:w-96 sm:h-96 text-cyan" fill="currentColor" viewBox="0 0 24 24">
          {/* Analytics/Data Chart Icon */}
          <rect x="2" y="11" width="3" height="9" opacity="0.8" />
          <rect x="7" y="6" width="3" height="14" opacity="0.8" />
          <rect x="12" y="3" width="3" height="17" opacity="0.8" />
          <rect x="17" y="8" width="3" height="12" opacity="0.8" />
      ...
      {/* Main Content */}
      <div className="relative z-10 max-w-3xl w-full pt-12 sm:pt-0">
        {/* Name */}
        <h1
          ref={nameRef}
          className="font-heading text-4xl sm:text-5xl md:text-6xl font-black text-off-white mb-4 sm:mb-6 leading-tight"
        >
          Yashvi Nagda
        </h1>
        ...
        <p
          ref={titleRef}
          className="font-body text-base sm:text-lg md:text-2xl text-light-gray mb-6 sm:mb-8 italic"
        >
        ...
        <a
          ...
          href={resumePDF}
          className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-red-500 to-orange-500 text-white font-body font-bold text-base sm:text-lg rounded-lg hover:scale-105 hover:shadow-2xl hover:shadow-red-500/50 transition-all duration-300 group cursor-pointer active:scale-95"
        >
          <span>Resume</span>
      ...
      <div className="fixed right-3 sm:right-4 md:right-8 top-1/2 -translate-y-1/2 flex flex-col gap-3 sm:gap-4 md:gap-6 z-50">
        {/* GitHub */}
        <a
          href="https://github.com/yourusername"
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-cyan/50 flex items-center justify-center text-cyan hover:bg-cyan/10 hover:border-cyan hover:scale-110 transition-all duration-300"
          aria-label="GitHub"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-electric-blue/50 flex items-center justify-center text-electric-blue hover:bg-electric-blue/10 hover:border-electric-blue hover:scale-110 transition-all duration-300"
          aria-label="LinkedIn"
        >
          <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-pink-500/50 flex items-center justify-center text-pink-500 hover:bg-pink-500/10 hover:border-pink-500 hover:scale-110 transition-all duration-300"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-blue-600/50 flex items-center justify-center text-blue-600 hover:bg-blue-600/10 hover:border-blue-600 hover:scale-110 transition-all duration-300"
          aria-label="Facebook"
        >
          <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-ice-blue/50 flex items-center justify-center text-ice-blue hover:bg-ice-blue/10 hover:border-ice-blue hover:scale-110 transition-all duration-300"
          aria-label="Email"
        >
